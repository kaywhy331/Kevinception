...
export const artifacts: ArtifactDefinition[] = [
  {
    id: 'signal-fragment', title: 'Signal Fragment', meaning: 'Curiosity persists while its container changes.',
    transformations: {
  ...
  {
    id: 'identity-handle', title: 'Identity Handle', meaning: 'Online identity evolves from initials into a reconstructed self.',
    transformations: {
  ...
  {
    id: 'project-blueprint', title: 'Project Blueprint', meaning: 'The same idea can become a manual, attachment, post, clip, graph, or memory.',
    transformations: {
  ...
  {
    id: 'next-layer-message', title: 'Message From the Next Layer', meaning: 'Each era receives evidence that another interface exists beyond it.',
    transformations: {
  ...
  {
    id: 'human-gate', title: 'Human Gate', meaning: 'The interface changes; meaningful decisions remain human.',
    transformations: {
