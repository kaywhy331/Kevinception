...
export const artifacts: ArtifactDefinition[] = [
  {
    ...
    transformations: {
      '1990': '8-bit collectible', '2000': 'downloaded .SIG file', '2010': 'hidden archive SKU', '2020': 'saved draft asset', '2030': 'context packet', '2040': 'memory shard'
    }
  },
  {
    ...
    transformations: {
      '1990': 'high-score initials', '2000': 'screen name', '2010': 'seller account', '2020': 'creator handle', '2030': 'collaborator identity', '2040': 'reconstruction key'
    }
  },
  {
  ...
  },
  {
    ...
    transformations: {
      '1990': 'scrambled broadcast', '2000': 'unknown IM', '2010': 'future-dated order note', '2020': 'impossible comment', '2030': 'unregistered handoff', '2040': 'message from the present'
    }
  },
  {
    ...
    transformations: {
      '1990': 'player choice', '2000': 'download confirmation', '2010': 'release or hold order', '2020': 'post or draft', '2030': 'approve/revise/reject', '2040': 'preserve/reinterpret/forget'
    }
  }
];
